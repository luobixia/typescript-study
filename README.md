...
- [1. Table of Content](#1-table-of-content)  
    - [1.1. 重塑类型思维](#11-重塑类型思维)  
        - [1.1.1. 为什么使用typescript?](#111-为什么使用typescript)  
- [1.2. 基础类型:强类型与弱类型](#12-基础类型强类型与弱类型)  
- [1.3. 基础类型:动态类型与静态类型](#13-基础类型动态类型与静态类型)  
- [1.4. 编写你的第一个typescript程序](#14-编写你的第一个typescript程序)    
    - [1.4.1. 类型注解](#141-类型注解)  
- [1.5. 基本类型](#15-基本类型)  
- [1.6. 接口](#16-接口)    
  - [1.6.1. 对象类型的接口](#161-对象类型的接口)    
  - [1.6.2. 函数类型的接口](#162-函数类型的接口)  
- [1.7. ts中与函数相关的知识点](#17-ts中与函数相关的知识点)  
- [1.8. ts中的类](#18-ts中的类)    
  - [1.8.1. 抽象类与多态](#181-抽象类与多态)  
- [1.9. 类与接口](#19-类与接口)  
- [1.10. 泛型](#110-泛型)    
  - [1.10.1. 泛型函数与泛型接口](#1101-泛型函数与泛型接口)    
  - [1.10.2. 泛型类与泛型约束](#1102-泛型类与泛型约束)
